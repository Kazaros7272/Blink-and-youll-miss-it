...
- **Confetti Effects**: Celebratory confetti triggered when the user scores 80% or higher, created using JavaScript function loaded from [CDN](https://cdn.jsdelivr.net/npm/canvas-confetti@1.5.1/dist/confetti.browser.min.js).
